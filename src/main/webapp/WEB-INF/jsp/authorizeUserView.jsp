...
<section>
    ...
    <!--    Dit is dummy text hieronder>-->
            <div class="inlogPanel">
                <form class="koppelen" autocomplete="on" method="get" action="/account-statement" modelAttribute="newuser">
                    <h2>Gemachtigde toevoegen</h2>
                    <div class ="headimage"><img class = "picture" src="../../images/yesyes.jpg" alt="Open Account"></div>
                    <label for="rekeningnummer">Rekeningnummer</label><br>
                    <input type="text" id="rekeningnummer" name="rekeningnummer" class="field"><br><br>
                    <label for="username">Username (e-mailadres)</label><br>
                    <input type="text" id="username" name="username" class="field"><br><br>
                    <input type="submit" value="Machtigen" class="btn btn-warning submit">
